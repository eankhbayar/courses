...
int main(){
    ...
    // initialize UART
    // UART0 is used to show data on the screen
    // UART1 is used to send data to the servo
    ...
    // initialize MPU6050
    // you may do not care this part
    g_bMPU6050Done = false;
    MPU6050Init(&g_sI2CMSimpleInst, MPU6050Callback, &g_sMPU6050Inst);
